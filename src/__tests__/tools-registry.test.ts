...
import { LOGIN_POLICY_TOOLS, LOGIN_POLICY_HANDLERS } from '../tools/login-policy.js';
...
describe('tool registry', () => {
  it('has 41 total tools', () => {
    ...
    // + 4 org-member + 2 provisioning + 2 login-policy + 2 login-texts + 4 smtp
    // + 1 utility + 2 portal = 41
